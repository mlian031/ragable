      ...
      <main className="flex-grow">
        <div className="container mx-auto px-4 py-12 prose prose-lg max-w-4xl">
          ...
          <p className="font-semibold text-red-600">
            Please remember: This is a template generated by an AI based on the
            information you provided and standard privacy practices. It is NOT
            legal advice. Ragable Inc. MUST consult with qualified legal counsel
            specializing in privacy law (including Canadian regulations like
            PIPEDA) to review, revise, and finalize this document to ensure it
            complies with all applicable laws and regulations and accurately
            reflects their specific data handling practices.
          </p>
